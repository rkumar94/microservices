...
public class GdataSpreadSheetReaderUnitTest {
    ...
    public void shouldGetColumnValues() throws Exception {
        ...
        doReturn(Arrays.asList("row1", "row2")).when(spreadsheet).extractColumnValues(rows, "col");
    ...
    public void filterRowsByColumnName() throws Exception {
        ...
        List rows = Arrays.asList(row1, row2);
    ...
    public void findRowByColumnHeaderAndColumnValue() throws Exception {
        ...
        doReturn(Arrays.asList(first, second)).when(spreadsheet).readRows();
    ...
    public void ifHeaderExist() throws Exception {
        ...
        String header = "a";
        when(reader.getHeaders()).thenReturn(new HashSet<>(Arrays.asList("a", "b", "c")));
